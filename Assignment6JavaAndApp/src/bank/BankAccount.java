...
public class BankAccount {
	...
	private double interest; // Account interest rate
	...
	public BankAccount(double startBalance, double startInterest) throws NegativeStartingBalance, NegativeInterestRate {
		...
		if (startInterest >= 0)
			...
			throw new NegativeInterestRate(startInterest);
	}
